...
\textbf{结果分析：} 
测得低频通带增益约为 \SI{4}{\decibel} ($1.58$倍)，在 $f \approx \SI{3.12}{\kilo\hertz}$ 处，增益下降约 \SI{3}{\decibel}，输出幅度约为通带的 $0.707$ 倍。拟合的幅频特性曲线如图 \ref{fig:lpf_bode} 所示。实测截止频率与理论值 \SI{3120}{\hertz} 基本吻合。
